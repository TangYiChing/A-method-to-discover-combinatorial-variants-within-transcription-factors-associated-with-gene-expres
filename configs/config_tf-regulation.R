...
tf_snp_annot_dir='/data2/GTEx_v6/code/script/TFs_model_w_GTEx_Tissue_Wide_CV_elasticNet/TF-TWAS/example/inputs/annotation/tf_snp_annot/eQTL/brain_hippocampus/'
